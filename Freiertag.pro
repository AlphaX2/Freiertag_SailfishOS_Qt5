...
ferien2013.path = /usr/share/Freiertag/data/2013/ferien
ferien2013.files += data/2013/ferien/*.ics
feiertage2013.path = /usr/share/Freiertag/data/2013/feiertage
feiertage2013.files += data/2013/feiertage/*.ics

# define data for 2014
ferien2014.path = /usr/share/Freiertag/data/2014/ferien
ferien2014.files += data/2014/ferien/*.ics
feiertage2014.path = /usr/share/Freiertag/data/2014/feiertage
feiertage2014.files += data/2014/feiertage/*.ics

# define data for 2015
ferien2015.path = /usr/share/Freiertag/data/2015/ferien
ferien2015.files += data/2015/ferien/*.ics
feiertage2015.path = /usr/share/Freiertag/data/2015/feiertage
